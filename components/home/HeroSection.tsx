...
const HeroSection = () => {
  return (
    <section
      id="home"
      className="relative grid items-center gap-8 overflow-hidden rounded-[2.5rem] border border-border bg-card/75 p-6 shadow-2xl backdrop-blur-lg sm:p-8 md:grid-cols-[1.2fr_0.8fr] md:p-14"
    >
      ...
      <div className="relative space-y-6">
        ...
        <div className="space-y-3 text-sm leading-relaxed text-foreground/70 md:text-base">
          {DATA.description}
        </div>
        <div className="flex flex-wrap items-center gap-4 pt-2">
          <LinkComponent to={DATA.calendlyUrl} className="inline-flex w-full items-center justify-center rounded-full bg-primary px-6 py-3 text-sm font-semibold text-background shadow-lg transition-transform hover:-translate-y-0.5 sm:w-auto">
            Book a Meeting
          </LinkComponent>
          <a
      ...
      <div className="relative">
        <div className="aspect-[4/5] w-full overflow-hidden rounded-[2rem] border border-border bg-card/70 shadow-xl backdrop-blur-md sm:max-w-sm sm:mx-auto md:max-w-none">
